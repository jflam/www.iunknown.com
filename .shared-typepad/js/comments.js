...
function playCaptcha( anchor, str )
{
    var embed_audio = '<embed src="' + anchor.href + '" hidden="true" autostart="true" />';
    var link_audio = '<br /><a href="' + anchor.href + '">' + str + '</a>';

    document.getElementById( 'audio-captcha-embed' ).innerHTML = '';
    document.getElementById( 'audio-captcha-embed' ).innerHTML = embed_audio;

    document.getElementById( 'audio-captcha-link' ).innerHTML = '';
    document.getElementById( 'audio-captcha-link' ).innerHTML = link_audio;
